...
class CooccurrenceColumnWrapperReducer extends MapReduceBase with Reducer[IntWritable,VectorOrPrefWritable,  IntWritable,Iterator[VectorOrPrefWritable]] {
...
class UserVectorSplitterReducer extends MapReduceBase with Reducer[IntWritable,VectorOrPrefWritable,  IntWritable,Iterator[VectorOrPrefWritable]] {
